...
<head>
    <title>Profil | Futsal Gacor</title>
...
<body>
    ...
    <section class="maps" id="maps">
        <h3 class="header-text">Gacor Venue</h3>
        <p>Lokasi Futsal Gacor tersebar pada beberapa lokasi </p>
